...
class ProjectileSim:
    ...
    def update(self):
        ...
        self.positionx = self.positionx + positions[0] * self.interval
        self.positiony = self.positiony + positions[1] * self.interval
        self.positionz = self.positionz + positions[2] * self.interval
